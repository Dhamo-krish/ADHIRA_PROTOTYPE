...
public class maintypeItemAdapter extends RecyclerView.Adapter<maintypeItemAdapter.ViewHolder>
{
    private int listItemLayout;
    private ArrayList<maintypeAdapter> list1;
    private static MyClickListener myClickListener1;
    public maintypeItemAdapter(int layout, ArrayList<maintypeAdapter> list)
    {
        this.list1=list;
